...
public struct AddInputView: AddPropertyProtocol {
    
    @ObservedObject public var builder: GameBuilder
    
    @StateObject fileprivate var object: AddProperty
    
    init(_ builder: GameBuilder, _ input: InputEnum, _ used: StringBuilders) {
    ...
    private struct QueryView: AddPropertyProtocol {
        ...
        init(_ input: InputEnum, _ used: StringBuilders, _ binding: Binding<String>) {
...
fileprivate class AddProperty: ObservableObject {
    ...
    let input: InputEnum
    let used: StringBuilders
    
    init(_ i: InputEnum, _ u: StringBuilders) {
        self.input = i
        self.used = u
    }
...
fileprivate extension AddPropertyProtocol {
    ...
    var used: StringBuilders { self.object.used }
