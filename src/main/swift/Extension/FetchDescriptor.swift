...
//    
//    static func getByCompositeKey(_ helper: RelationHelper) -> Self {
//        let game: UUID = helper.game
//        let key: UUID = helper.key
//        let value: UUID = helper.value
//        let predicate: RelationPredicate = .getByCompositeKey(game, key, value)
//        return .init(predicate: predicate, sortBy: .defaultValue)
//    }
//    
