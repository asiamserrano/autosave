...
//import SwiftData
//
//public struct RelationHelper {
//    let game: UUID
//    let key: UUID
//    let value: UUID
//    
//    init(_ game: Uuidentifor, _ key: Uuidentifor, _ value: Uuidentifor? = nil) {
//        self.game = game.uuid
//        self.key = key.uuid
//        self.value = value?.uuid ?? key.uuid
//    }
//    
//}
//
...
//    
//    public init(_ helper: RelationHelper) {
//        self.uuid = .init()
//        self.game_uuid = helper.game
//        self.property_key_uuid = helper.key
//        self.property_value_uuid = helper.value
//        self.count = .one
//    }
//    
...
//            return propertyBase
//        case .platform:
//            return PropertyCategory.platform
//        }
//    }
//    
//}
